...
namespace FPS.Guns
{
    ...
    public class GunScriptableObject : ScriptableObject, System.ICloneable
    {
        ...
        public void EndReload()
        {
            ...
            // Je�li animation coroutine wci�� dzia�a � zatrzymaj i natychmiast przywr��.
            if (ActiveMonoBehaviour != null)
            {
                if (reloadAnimationCoroutine != null)
                {
                ...
                // upewnij si� �e bro� wr�ci do oryginalnej pozycji (szybki lerp)
                if (Model != null)
                {
                    // uruchamiamy korutin�, aby dopilnowa�a p�ynnego przywr�cenia
