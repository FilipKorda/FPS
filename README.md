...
One of the main goals of the project was to create systems that are **modular, reusable and independent from specific scenes**.

Instead of implementing gameplay logic directly inside individual objects, functionality is separated into dedicated systems.
